...
@Component({
  ...
  template: `
    <div
      ...
      [class.opacity-60]="meeting().feedback_status === dismissed"
      role="article"
    ...
    >
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-center gap-2 mb-1 flex-wrap">
            ...
            <span
              ...
              [class]="getBadgeClasses(meeting().meeting_type)"
            >
          ...
          <div class="flex items-center gap-3 text-sm text-muted-foreground-1 flex-wrap">
            <span class="inline-flex items-center gap-1">
              ...
              {{ meeting().start_time | date:'MMM d, y' }}
            </span>
            <span class="inline-flex items-center gap-1">
              ...
              {{ meeting().start_time | date:'h:mm a' }} - {{ meeting().end_time | date:'h:mm a' }}
            </span>
        ...
        <div class="flex items-center gap-2 shrink-0">
          @if (meeting().feedback_status !== dismissed) {
            <button
              type="button"
              ...
              (click)="giveFeedback.emit(meeting().meeting_id)"
            ...
            <button
              ...
              (click)="dismissMeeting.emit(meeting().meeting_id)"
