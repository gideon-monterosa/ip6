  ...
  template: `
    <div class="flex items-center justify-center gap-x-3">
      ...
      <button
        ...
        class="inline-flex items-center justify-center size-8 rounded-full text-muted-foreground-1 hover:bg-muted hover:text-foreground transition-colors"
      >
      ...
      <!-- Date range label -->
      <span class="text-sm font-medium text-foreground min-w-[280px] text-center select-none">
        {{ label() }}
      </span>
      ...
      <button
        ...
        class="inline-flex items-center justify-center size-8 rounded-full transition-colors"
      ...
      @if (!isCurrentWeek()) {
        <button
          type="button"
          (click)="goToToday()"
          class="ml-1 px-3 py-1 text-xs font-medium rounded-full bg-primary text-white hover:bg-primary/90 transition-colors"
        >
          Today
        </button>
      }
